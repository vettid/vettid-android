...
2. Added `label` field support (was only accepting `invitee_alias`)
3. Added optional `peer_guid` field for tracking
4. Backwards compatible - `invitee_alias` still works

**New AMI:** `ami-0421915a7aae8e04c` (built 2026-01-01 16:24 UTC)
**Previous vault terminated** - new vault will be provisioned on next start

**Request format now works:**
```json
{
  "peer_guid": "pending",
  "label": "user-09FC",
...
```json
{
  "connection_id": "conn-abc123...",  // Generated by handler
  "credentials": "-----BEGIN NATS USER JWT-----\n...",
  "message_space_topic": "MessageSpace.xyz.forOwner.>",
  "expires_at": "2026-01-02T16:35:00Z"
}
```
