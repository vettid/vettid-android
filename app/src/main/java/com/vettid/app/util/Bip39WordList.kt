 ...
 * Used for recovery phrase generation and validation.
 */
object Bip39WordList {
    ...
    /**
     * Check if a word is valid in the BIP-39 word list.
     */
    ...
    /**
     * Get word suggestions for autocomplete based on prefix.
     */
    fun getSuggestions(prefix: String, limit: Int = 5): List<String> {
        if (prefix.isBlank()) return emptyList()
        val lowerPrefix = prefix.lowercase()
        return words.filter { it.startsWith(lowerPrefix) }.take(limit)
    }

    /**
     * Get the index of a word in the word list.
